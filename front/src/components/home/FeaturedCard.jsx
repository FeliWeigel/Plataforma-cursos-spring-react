  ...
  return (
    <Card variant='outlined' sx={{
      ...
      transition: 'all .4s'
        ...
        {course.name.toString().includes('Node') ? <Icon icon={socialNodejs} size={75} className='course-icon'></Icon> : null}
        {course.name.toString().startsWith('Java') ? <Icon icon={mug} size={70} className='course-icon'></Icon> : null}
